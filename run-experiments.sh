...
(
    set -x
    time cargo run --release -- carbon-pricing --graph "$NETWORKS/Berlin-Center/berlin-center_net.tntp" \
    --demand "$NETWORKS/Berlin-Center/berlin-center_trips.tntp" --out_csv results/berlin-center-edge-based-cordon.csv \
...
(
    set -x
    time cargo run --release -- carbon-pricing --graph "$NETWORKS/Berlin-Center/berlin-center_net.tntp" \
        --demand "$NETWORKS/Berlin-Center/berlin-center_trips.tntp" --out_csv results/berlin-center-carbon-pricing.csv \
        --min_price 0 --max_price 10 --steps 101 --min_per_time_unit 0.01666666667 --km_per_distance_unit=0.001
...
(
    ...
    --demand "$NETWORKS/Anaheim/Anaheim_trips.tntp" --out_csv results/anaheim-carbon-pricing.csv \
...
(
    ...
    --demand "$NETWORKS/Winnipeg/Winnipeg_trips.tntp" --out_csv results/winnipeg-carbon-pricing.csv \
...
(
    ...
    --demand "$NETWORKS/SiouxFalls/SiouxFalls_trips.tntp" --out_csv results/sioux-falls-carbon-pricing.csv \
    --min_price 0 --max_price 100 --steps 101 --km_per_distance_unit=0.001 --min_per_time_unit 0.01666666667
