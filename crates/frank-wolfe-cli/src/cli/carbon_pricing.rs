...
use frank_wolfe::{
    ...
    optimization::edge_based_convex_program::EdgeBasedConvexProgramInstance,
    optimization::edge_based_solution::EdgeBasedSolution,
    optimization::frank_wolfe::{ConvexProgramInstance, FrankWolfeResult, solve_convex_program},
