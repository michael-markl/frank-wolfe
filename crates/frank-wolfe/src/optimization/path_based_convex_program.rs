...
use crate::collections::{HashMap, map_new};
use crate::common::{
...
use crate::network::bundle_index::Bundle;
use crate::network::path_index::{Path, PathIndex};
use crate::optimization::edge_based_solution::EdgeBasedSolution;
use crate::optimization::frank_wolfe::{FrankWolfeResult, frank_wolfe_step};
use crate::optimization::path_based_solution::PathBasedSolution;
use crate::routing::astar_tree::ShortestPathResult;
use crate::{
    ...
    optimization::frank_wolfe::{ConvexProgramInstance, LinearizedSubProblemSolution, SolutionOps},
...
impl<'g, 'd, 't, 'b, 'bi, 'idx, 'p> PathBasedConvexProgramInstance<'g, 'd, 't, 'b, 'bi, 'idx, 'p> {
    ...
    pub fn remove_high_regret_paths_with_on_step(
        ...
        loop {
            ...
            let (new_solution, approximation, max_regret, mean_regret, shortest_flow) = self
